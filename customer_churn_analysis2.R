...
# The value of the following columns affecting the model and introducing the NA value 
#for "No phone service" and  and "No internet service" need to cleanup the data for 
#these columns MultipleLine,OnlineSecurity,OnlineBackup,DeviceProtection,TechSupport,StreamingTV,StreamingMovies
